    ...
    <Document>
      ...
      <Page size="A4" orientation="landscape" style={s.pageLand}>
        ...
        <View style={{ marginTop: 4 }}>
          ...
          <Text style={{ fontSize: 5, color: "#555" }}>Кол. 3 (Признак): 6 = работы/услуги произведенные в РК. Для импортных товаров - другой код.</Text>
          ...
          <Text style={{ fontSize: 5, color: "#555" }}>Кол. 16 (НДС): "Без НДС" для ИП на упрощенке. Плательщики НДС - укажите 12%.</Text>
